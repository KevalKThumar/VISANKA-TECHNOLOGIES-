...
class ManagerAddSalesExecutive extends StatefulWidget {
  const ManagerAddSalesExecutive({super.key});

  @override
  State<ManagerAddSalesExecutive> createState() => _ManagerAddSalesExecutiveState();
}

class _ManagerAddSalesExecutiveState extends State<ManagerAddSalesExecutive> {
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: InkWell(
              onTap: () {
                // Navigator.pushNamed(context, RoutesName.ManagerLogin);
              },
              child: const Icon(
                Icons.notifications,
                color: Colors.white,
