...
class ManageManager extends StatefulWidget {
  const ManageManager({super.key});

  @override
  State<ManageManager> createState() => _ManageManagerState();
}

class _ManageManagerState extends State<ManageManager> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: FinappColor.appBarColor,
        onPressed: () {
          Navigator.pushNamed(context, RoutesName.adminAddManager);
        },
        child: const Icon(
          Icons.add,
          color: Colors.white,
                ...
                return Padding(
                  ...
                  child: ListTile(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        RoutesName.removeRestrictManager,
                      );
                    },
                    title: const Text(
                      "Manager Name",
